...
public class JFFuncionario extends javax.swing.JFrame {
    ...
    private void carregaDados() {
        ...
        if (isNull(id) == false) {
            ...
            BancoDados banco = new BancoDados();
            Map dados = banco.recuperaDadosChavePrimaria("id", id, "tb_funcionario");
            ...
            JTCargo.setText((String) dados.get("cargo"));
            JDDataAdmissao.setDate(Algoritmos.converteStringData((String) dados.get("data_admissao")));

            System.out.println(dados.get("data_admissao"));
    ...
    private void initComponents() {
        ...
        JDDataAdmissao = new com.toedter.calendar.JDateChooser();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(JCUf, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(24, 24, 24)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(JTFone, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel9)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(JDDataAdmissao, javax.swing.GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE))
                            .addComponent(JTNome))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabel9))
                    .addComponent(JDDataAdmissao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private boolean validarCampos() {
        ...
        if (isNull(id) == true) {
            ...
            if (banco.isRegistroExiste("tb_funcionario", "cpf", this.JTCpf.getText()) == true) {

                // mensagem
                JOptionPane.showMessageDialog(null, "Funcionário já cadastrado por cpf.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (validarCampos() == true) {
            ...
            dados.put("data_admissao", Algoritmos.retornaDataFormatadaJCalendar(this.JDDataAdmissao));
            ...
            dados.put("cargo", this.JTCargo.getText());

            // se não houver id cadastra, caso contrário atualiza
            if (isNull(this.id) == true) {

                banco.inserirDados(dados, "tb_funcionario");

            } else {

                dados.put("id", this.id);
                banco.AtualizarDados(dados, "tb_funcionario");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        // abre janela
        JFFuncionarioView janela = new JFFuncionarioView();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        BancoDados banco = new BancoDados();
        if (banco.removeRegistroChavePrimaria("id", id, "tb_funcionario", "Remover funcionário?") == true) {
    ...
    private com.toedter.calendar.JDateChooser JDDataAdmissao;
