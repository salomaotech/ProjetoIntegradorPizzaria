/*
carrega os dados do banco de dados e exibe em um JList
 */
package sistema;
 ...
 * @version 1.0
 */
public class JListDados {

    private String tabela;
    private String colunaExibir;

    // construtor
    public JListDados(String tabela, String colunaExibir) {
    ...
    public List recuperaDados(JList objLista) {
        ...
        try {
            ...
            while (resultados.next()) {
                ...
                // adiciona
                listModel.add(contador, resultados.getString((String) colunaExibir));
    ...
    public List pesquisaDados(JList objLista, Map colunasPesquisa) {
